...
<html>
	<head>
        ...
        <link rel="stylesheet" href="../../../assets-sistema/css/card-funcionarios.css" />
				...
				<!-- Intro -->
						...
						<div id="wrapper">
								<div class="main">
                                    ...
                                    <h1 class="txt">SELECIONE O FUNCIONARIO OU A SEGURADORA</h1>
                                    
                                        <div class="itens-funcionarios">
                                            <a href="fun-fin" class="gallery__link">
                                                <figure class="gallery__thumb">
                                                    <img src="../../../assets-sistema/images/user.png" alt="#" class="gallery__image">
                                                    <p class="txt-funcionarios">VIZUALIZAR HORAS TRABALHADAS</p>
                                                </figure>
                                            </a>
                                    
                                            <a href="seg-fin" class="gallery__link">
                                                <figure class="gallery__thumb">
                                                    <img src="../../../assets-sistema/images/add-insurer.png" alt="#" class="gallery__image">
                                                    <p class="txt-funcionarios">VIZUALIZAR SERVIÇOS REALIZADOS</p>
                                                </figure>
                                            </a>
										</div>							
